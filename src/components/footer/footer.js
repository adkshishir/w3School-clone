...
const Footer = () => {
  return (
    <div className="footer-container">
      <div className="footer-btn-container footer-item">
        <Footerbtn name={"QUIZZES"} />
        <Footerbtn name={"EXERCISE"} />
        <Footerbtn name={"CERTIFICATES"} />
        <Footerbtn name={"UPGRADE"} />
        <Footerbtn name={"SUPPORT"} />
        <Footerbtn name={"SPACES"} />
        <Footerbtn name={"NEWSLETTER"} />
      </div>
      <div className="footer-item"> FORUM | ABOUT</div>
